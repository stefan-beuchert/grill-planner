...
import { ShoppingBasket, UtensilsCrossed, Beer, Package } from "lucide-react";
...
export type SharedPurchaseItem = ContributionItem & { category: ItemCategory };

export function SharedPurchasesSection({
  slug,
  items,
  note,
  isAdmin = false,
